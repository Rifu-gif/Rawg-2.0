...
export default function RegisterPage() {
  ...
  return (
    <div className="mx-auto max-w-md rounded-3xl border border-[var(--line)] bg-white p-8 shadow-xl">
      <h1 className="text-2xl font-semibold [font-family:var(--font-display)]">Create an account</h1>
      <p className="mt-2 text-sm text-[var(--ink-3)]">Save favorites and review games.</p>
      ...
      <p className="mt-4 text-sm text-[var(--ink-3)]">
        ...
        <Link className="text-[var(--brand-1)]" href="/auth/login">
          Sign in
        </Link>
      </p>
    </div>
